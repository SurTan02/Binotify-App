<?php
    ...
    // BODY HTML 
    $header_html = str_replace('{title}', "Brisic - Add Album" , $header_html);
    $detail_lagu_html = file_get_contents('./view/html/detail_lagu.html');
    $content_page_html = file_get_contents('./view/html/tambah_album.html');
    $foot_html = file_get_contents('./view/html/templates/foot.html');
    $foot_html = str_replace('{js1}', './view/js/tambah_album.js', $foot_html);
